...
export default function OriginalHeader() {
  useEffect(() => {
    // Exact clone of Marex xfa scroll bindings for navbar swap
    // Binds to window to ensure the transition is identically replicated inside the React Lifecycle.
    let didScroll;
    let lastScrollTop = 0;
    const delta = 5;
...
<ul class="sub-menu">
<li class="menu-item menu-item-type-post_type menu-item-object-market menu-item-has-children columns-one-column alignment-left menu-item-647"><a href="/platform">Investment & Trading Platform</a>
