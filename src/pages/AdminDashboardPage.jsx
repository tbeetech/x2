                    ...
                    filteredVerificationQueue.map((record) => (
                      <div key={record.id} className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                        ...
                        <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:flex-wrap">
                          ...
                          <button
                            type="button"
                            className="inline-flex items-center justify-center gap-2 rounded-full border border-white/10 px-4 py-2 text-xs font-semibold text-slate-200 transition hover:border-blue-400/40 hover:text-blue-200 min-h-[40px]"
